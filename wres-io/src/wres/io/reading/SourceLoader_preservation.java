...
public class SourceLoader
{
    ...
    /**
     * A value class that stores a {@link DataSourceConfig.Source} and whether it should be loaded
     * or linked. If it should be linked, then the type of link to create is a 
     * {@link LeftOrRightOrBaseline}. A "link" in this context means an entry in 
     * <code>wres.ProjectSource</code> using the identifier of an already ingested source. Each 
     * source may have zero or more links. The source is linked to its own context by
     * default.
     * 
    ...
    private static class DataSource
    {
        ...
        private static DataSource of( DataSourceConfig.Source source,
        ...
        private Set<LeftOrRightOrBaseline> getLinks()
        {
        ...
        private DataSourceConfig.Source getSource()
        {
            return this.source;
        }
        ...
        private DataSourceConfig getContext()
        {
            return this.context;
        }
