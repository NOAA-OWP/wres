...
public class SingleValuedPoolGenerator extends PoolGenerator<Double, Double>
{
        ...
        try
        {
            ...
            for ( TimeWindow nextWindow : timeWindows )
            {
                Supplier<Stream<TimeSeries<Double>>> rightSupplier =
                        this.getRetrieverBuilder( rightConfig.getType() )
                            .setProjectId( projectId )
                ...
                {
                    leftSupplier = this.getRetrieverBuilder( leftConfig.getType() )
                                       .setProjectId( projectId )
                                       .setVariableFeatureId( leftVariableFeatureId )
                                       .setLeftOrRightOrBaseline( LeftOrRightOrBaseline.LEFT )
                                       .setTimeWindow( nextWindow )
                ...
                if ( project.hasBaseline() )
                {
                    ...
                    else
                    {
                        Supplier<Stream<TimeSeries<Double>>> baselineSupplier =
                                this.getRetrieverBuilder( baselineConfig.getType() )
                                    .setProjectId( projectId )
    ...
    DoubleUnaryOperator getTransformer( DoubleBoundsType valueConfig )
    {
