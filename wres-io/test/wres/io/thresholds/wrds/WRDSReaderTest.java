...
public class WRDSReaderTest {
    ...
    private static FeaturePlus createFeature(final String lid) {
        return FeaturePlus.of(
                new Feature(
                        null,
                        null,
                        null,
    ...
    private static final FeaturePlus PTSA1 = WRDSReaderTest.createFeature("PTSA1");
    private static final FeaturePlus MNTG1 = WRDSReaderTest.createFeature("MNTG1");
    private static final FeaturePlus BLOF1 = WRDSReaderTest.createFeature("BLOF1");
    private static final FeaturePlus CEDG1 = WRDSReaderTest.createFeature("CEDG1");
    private static final FeaturePlus SMAF1 = WRDSReaderTest.createFeature("SMAF1");
    private static final FeaturePlus CHAF1 = WRDSReaderTest.createFeature("CHAF1");
    private static final FeaturePlus OKFG1 = WRDSReaderTest.createFeature("OKFG1");
    private static final FeaturePlus TLPT2 = WRDSReaderTest.createFeature("TLPT2");
    private static final FeaturePlus NUTF1 = WRDSReaderTest.createFeature("NUTF1");
    private static final FeaturePlus CDRA1 = WRDSReaderTest.createFeature("CDRA1");
    private static final FeaturePlus MUCG1 = WRDSReaderTest.createFeature("MUCG1");
    private static final FeaturePlus PRSG1 = WRDSReaderTest.createFeature("PRSG1");
    private static final FeaturePlus LSNO2 = WRDSReaderTest.createFeature("LSNO2");
    private static final FeaturePlus HDGA4 = WRDSReaderTest.createFeature("HDGA4");
    private static final FeaturePlus FAKE3 = WRDSReaderTest.createFeature("FAKE3");
    private static final FeaturePlus CNMP1 = WRDSReaderTest.createFeature("CNMP1");
    private static final FeaturePlus WLLM2 = WRDSReaderTest.createFeature("WLLM2");
    private static final FeaturePlus RCJD2 = WRDSReaderTest.createFeature("RCJD2");
    private static final FeaturePlus MUSM5 = WRDSReaderTest.createFeature("MUSM5");
    private static final FeaturePlus DUMM5 = WRDSReaderTest.createFeature("DUMM5");
    private static final FeaturePlus DMTM5 = WRDSReaderTest.createFeature("DMTM5");
    private static final FeaturePlus PONS2 = WRDSReaderTest.createFeature("PONS2");
    private static final FeaturePlus MCKG1 = WRDSReaderTest.createFeature("MCKG1");
    private static final FeaturePlus DSNG1 = WRDSReaderTest.createFeature("DSNG1");
    private static final FeaturePlus BVAW2 = WRDSReaderTest.createFeature("BVAW2");
    private static final FeaturePlus CNEO2 = WRDSReaderTest.createFeature("CNEO2");
    private static final FeaturePlus CMKT2 = WRDSReaderTest.createFeature("CMKT2");
    private static final FeaturePlus BDWN6 = WRDSReaderTest.createFeature("BDWN6");
    private static final FeaturePlus CFBN6 = WRDSReaderTest.createFeature("CFBN6");
    private static final FeaturePlus CCSA1 = WRDSReaderTest.createFeature("CCSA1");
    private static final FeaturePlus LGNN8 = WRDSReaderTest.createFeature("LGNN8");
    private static final FeaturePlus BCLN7 = WRDSReaderTest.createFeature("BCLN7");
    private static final FeaturePlus KERV2 = WRDSReaderTest.createFeature("KERV2");
    private static final FeaturePlus ARDS1 = WRDSReaderTest.createFeature("ARDS1");
    private static final FeaturePlus WINW2 = WRDSReaderTest.createFeature("WINW2");
    private static final FeaturePlus SRDN5 = WRDSReaderTest.createFeature("SRDN5");
    private static final FeaturePlus MNTN1 = WRDSReaderTest.createFeature("MNTN1");
    private static final FeaturePlus GNSW4 = WRDSReaderTest.createFeature("GNSW4");
    private static final FeaturePlus JAIO1 = WRDSReaderTest.createFeature("JAIO1");
    private static final FeaturePlus INCO1 = WRDSReaderTest.createFeature("INCO1");
    private static final FeaturePlus PRMO1 = WRDSReaderTest.createFeature("PRMO1");
    private static final FeaturePlus PARO1 = WRDSReaderTest.createFeature("PARO1");
    private static final FeaturePlus BRCO1 = WRDSReaderTest.createFeature("BRCO1");
    private static final FeaturePlus WRNO1 = WRDSReaderTest.createFeature("WRNO1");
    private static final FeaturePlus BLEO1 = WRDSReaderTest.createFeature("BLEO1");

    private static final List<FeaturePlus> DESIRED_FEATURES = List.of(
            PTSA1,
            MNTG1,
            BLOF1,
            CEDG1,
    ...
    private static final FeaturePlus STEAK = WRDSReaderTest.createFeature("STEAK");
    private static final FeaturePlus BAKED_POTATO = WRDSReaderTest.createFeature("BakedPotato");
    ...
    {
        Map<FeaturePlus, Set<ThresholdOuter>> normalExtraction = WRDSReader.extract(
                normalResponse,
        ...
        Map<FeaturePlus, Set<ThresholdOuter>> funExtraction = WRDSReader.extract(
                funResponse,
                funThresholdConfig,
                this.unitMapper
        );
        ...
        Map<FeaturePlus, Set<ThresholdOuter>> alternativeNormalExtraction = WRDSReader.extract(
                normalResponse,
        ...
        Map<FeaturePlus, Set<ThresholdOuter>> normalButFunExtraction = WRDSReader.extract(
                funResponse,
                normalThresholdConfig,
                this.unitMapper
        );
    ...
    {
        Collection<String> groupedLocations = WRDSReader.groupLocations(DESIRED_FEATURES);
        ...
        for (; featureIndex < WRDSReader.LOCATION_REQUEST_COUNT; featureIndex++) {
            firstGroupBuilder.add(DESIRED_FEATURES.get(featureIndex).getFeature().getLocationId());
        }

        for (; featureIndex < WRDSReader.LOCATION_REQUEST_COUNT * 2; featureIndex++) {
            secondGroupBuilder.add(DESIRED_FEATURES.get(featureIndex).getFeature().getLocationId());
        }

        for (; featureIndex < DESIRED_FEATURES.size(); featureIndex++) {
            thirdGroupBuilder.add(DESIRED_FEATURES.get(featureIndex).getFeature().getLocationId());
        }
        ...
        Iterator<String> groupIterator = groupedLocations.iterator();
        String firstControl = groupIterator.next();
        String secondControl = groupIterator.next();
        String thirdControl = groupIterator.next();

        Assert.assertEquals(firstGroup, firstControl);
        Assert.assertEquals(secondGroup, secondControl);
        Assert.assertEquals(thirdGroup, thirdControl);
    }
    ...
    public void testReadThresholds() throws IOException {
        Map<FeaturePlus, Set<ThresholdOuter>> readThresholds = WRDSReader.readThresholds(
                systemSettings,
                normalThresholdConfig,
                this.unitMapper,
                DESIRED_FEATURES
