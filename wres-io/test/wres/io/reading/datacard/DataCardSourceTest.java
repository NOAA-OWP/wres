...
public class DataCardSourceTest
{
	...
	private static final String EXPECTED_QUERY_SHORT_RECORD =
            "123|'1949-01-01T11:00'|0.65|456|789\n"
            + "123|'1949-01-01T17:00'|0.229|456|789\n"
            + "123|'1949-01-01T23:00'|0.0|456|789\n"
            + "123|'1949-01-02T05:00'|0.024|456|789\n"
            + "123|'1949-01-02T11:00'|0.025|456|789\n"
            + "123|'1949-01-02T17:00'|0.001|456|789\n"
            + "123|'1949-01-02T23:00'|0.0|456|789\n"
            + "123|'1949-01-03T05:00'|0.0|456|789\n"
            + "123|'1949-01-03T11:00'|0.0|456|789\n"
            + "123|'1949-01-03T17:00'|0.0|456|789\n"
            + "123|'1949-01-03T23:00'|0.0|456|789\n"
            + "123|'1949-01-04T05:00'|0.001|456|789\n"
            + "123|'1949-01-04T11:00'|0.0|456|789\n"
            + "123|'1949-01-04T17:00'|0.015|456|789\n"
            + "123|'1949-01-05T05:00'|0.028|456|789\n"
            + "123|'1949-01-05T11:00'|0.526|456|789\n"
            + "123|'1949-01-05T17:00'|0.263|456|789\n"
            + "123|'1949-01-05T23:00'|0.188|456|789\n"
            + "123|'1949-01-06T05:00'|0.022|456|789\n"
            + "123|'1949-01-06T11:00'|0.0|456|789\n"
			...
			throws IOException
    {
        ...
        DataSourceConfig.Source confSource = new Source(current, f, "IN", "DRRC2",
                                                        null, "America/New_York", "-999.0", true,
                                                        true, "-998.0", "$");
            ...
            throws IOException
    {
        ...
        DataSourceConfig.Source confSource = new Source(current, f, "IN", "DRRC2",
                                                        null, "America/New_York", "-999.0, -997", true,
                                                        true, "-998.0", "$");
