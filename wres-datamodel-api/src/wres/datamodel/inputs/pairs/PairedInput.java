...
/**
 * A list of pairs to be iterated over by a metric. A {@link PairedInput} may contain a baseline dataset to be used in 
 * the same context (e.g. for skill scores). Optionally, a climatological dataset may be associated with the 
 * {@link PairedInput}. This may be used to derive quantiles from climatological probabilities, for example.
 * 
