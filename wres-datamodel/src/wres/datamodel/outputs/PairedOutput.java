...
public class PairedOutput<S, T> implements MetricOutput<List<Pair<S, T>>>, Iterable<Pair<S, T>>
{
    /**
    ...
    public static <S, T> PairedOutput<S, T> of( final List<Pair<S, T>> output, final MetricOutputMetadata meta )
    {
        return new PairedOutput<>( output, meta );
    }
    ...
    {
        if ( ! ( o instanceof PairedOutput ) )
        {
            return false;
        }
        final PairedOutput<?, ?> v = (PairedOutput<?, ?>) o;
    ...
    private PairedOutput( final List<Pair<S, T>> output, final MetricOutputMetadata meta )
    {
        //Validate
