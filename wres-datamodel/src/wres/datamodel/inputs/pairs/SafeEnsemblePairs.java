 ...
 */
public class SafeEnsemblePairs implements EnsemblePairs
{
    ...
    public static class EnsemblePairsBuilder extends DefaultMetricInputBuilder<PairOfDoubleAndVectorOfDoubles>
    {
