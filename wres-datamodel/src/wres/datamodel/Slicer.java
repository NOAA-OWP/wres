...
public final class Slicer
{
     ...
     * method 6 in the R function, <code>quantile{stats}</code>. This is largely equivalent to the
     * <code>PERCENTILE.EXC</code> function in Microsoft Excel, but the latter cannot compute the bounds or values
     * close to the bounds: <a href="https://stat.ethz.ch/R-manual/R-devel/library/stats/html/quantile.html">https://stat.ethz.ch/R-manual/R-devel/library/stats/html/quantile.html</a>.
     * Also see: <a href=
