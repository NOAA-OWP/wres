...
public final class OneOrTwoThresholdsTest
{
    ...
    {
        OneOrTwoThresholds thresholds = OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                                        Operator.GREATER,
                                                                                        ThresholdDataType.LEFT ) );
        assertTrue( "The threshold has an unexpected first threshold.",
                    DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                             Operator.GREATER,
                                             ThresholdDataType.LEFT )
    ...
    public void testGetSecond()
    {
        OneOrTwoThresholds thresholds = OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                                        Operator.GREATER,
                                                                                        ThresholdDataType.LEFT ),
                                                               DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.2 ),
                                                                                        Operator.GREATER,
                                                                                        ThresholdDataType.LEFT ) );
        assertTrue( "The threshold has an unexpected first threshold.",
                    DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.2 ),
    ...
    public void testEquals()
    {
        ...
        OneOrTwoThresholds otherThresholds =
                OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                Operator.GREATER,
                                                                ThresholdDataType.LEFT ) );
        ...
        OneOrTwoThresholds unequalOnFirst =
                OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.2 ),
                                                                Operator.GREATER,
                                                                ThresholdDataType.LEFT ),
                                       DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                Operator.GREATER,
        ...
        OneOrTwoThresholds unequalOnNullity =
                OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                Operator.GREATER,
                                                                ThresholdDataType.LEFT ),
                                       DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.3 ),
                                                                Operator.GREATER,
                                                                ThresholdDataType.LEFT ) );
        ...
        OneOrTwoThresholds unequalOnSecond =
                OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                Operator.GREATER,
                                                                ThresholdDataType.LEFT ),
                                       DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.4 ),
                                                                Operator.GREATER,
                                                                ThresholdDataType.LEFT ) );
    ...
    {
        // Consistent with equals
        OneOrTwoThresholds first = OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                                   Operator.GREATER,
                                                                                   ThresholdDataType.LEFT ) );
        OneOrTwoThresholds second = OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.1 ),
                                                                                    Operator.GREATER,
                                                                                    ThresholdDataType.LEFT ) );
        ...
        OneOrTwoThresholds third = OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.2 ),
                                                                                   Operator.GREATER,
                                                                                   ThresholdDataType.LEFT ) );
        ...
        // Transitive 
        OneOrTwoThresholds fourth = OneOrTwoThresholds.of( DataFactory.ofThreshold( OneOrTwoDoubles.of( 0.3 ),
                                                                                    Operator.GREATER,
                                                                                    ThresholdDataType.LEFT ) );
