...
public class ComparisonTest
{
    ...
    public void fancyPairWithEqualValuesIsEqualTest()
    {
        ...
        PairOfDoubleAndVectorOfDoubles firstPair = DataFactory.pairOf(3.0, firstArr);
        PairOfDoubleAndVectorOfDoubles secondPair = DataFactory.pairOf(3.0, secondArr);
    ...
    {
        double[] emptyArr = {};
        PairOfDoubleAndVectorOfDoubles firstPair = DataFactory.pairOf(1.0, emptyArr);
        PairOfDoubleAndVectorOfDoubles secondPair = DataFactory.pairOf(2.0, emptyArr);
    ...
    public void fancyPairEmptyArrayIsLessThanNonEmptyTest()
    {
        ...
        PairOfDoubleAndVectorOfDoubles emptyPair = DataFactory.pairOf(2.0, emptyArr);
        PairOfDoubleAndVectorOfDoubles nonEmptyPair = DataFactory.pairOf(2.0, nonEmptyArr);
    ...
    public void fancyPairEqualLengthButDifferentValuesInArrayTest()
    {
        ...
        PairOfDoubleAndVectorOfDoubles secondPair = DataFactory.pairOf(4.0, secondArr);
