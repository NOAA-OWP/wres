...
import wres.vis.writing.PNGBoxPlotWriter;
import wres.vis.writing.PNGDiagramWriter;
import wres.vis.writing.PNGDoubleScoreWriter;
import wres.vis.writing.PNGDurationDiagramWriter;
import wres.vis.writing.PNGDurationScoreWriter;
        ...
        Supplier<Set<Path>>
{
    ...
    {
        return new ProduceOutputsFromStatistics( resolvedProject,
                                                 writeWhenTrue,
                                                 sharedWriters );
    }
    ...
    private void buildPortableNetworkGraphicsConsumers()
    {
        ...
        {
            PNGDurationDiagramWriter pairedWriter = PNGDurationDiagramWriter.of( projectConfigPlus,
                                                                                 this.getDurationUnits(),
                                                                                 outputDirectory );
    ...
    private ProduceOutputsFromStatistics( ResolvedProject resolvedProject,
                                          BiPredicate<StatisticType, DestinationType> writeWhenTrue,
                                          SharedStatisticsWriters sharedWriters )
    {
