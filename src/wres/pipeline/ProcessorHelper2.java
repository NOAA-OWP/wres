 ...
 * @author Jesse Bickel
 */
class ProcessorHelper2
{
    private static final Logger LOGGER = LoggerFactory.getLogger( ProcessorHelper2.class );
    ...
    private static final ToIntFunction<Pool<TimeSeries<Pair<Double, Ensemble>>>> ENSEMBLE_TRACE_COUNT_ESTIMATOR =
            ProcessorHelper2.getEnsembleTraceCountEstimator();
    ...
    private static final ToIntFunction<Pool<TimeSeries<Pair<Double, Double>>>> SINGLE_VALUED_TRACE_COUNT_ESTIMATOR =
            ProcessorHelper2.getSingleValuedTraceCountEstimator();
            ...
            throws IOException
    {
        ...
        Path outputDirectory = ProcessorHelper2.createTempOutputDirectory( evaluationId );

        ProjectConfig projectConfig = projectConfigPlus.getProjectConfig();

        // Create a description of the evaluation
        wres.statistics.generated.Evaluation evaluationDescription =
                ProcessorHelper2.getEvaluationDescription( projectConfigPlus );

        // Create netCDF writers
        List<NetcdfOutputWriter> netcdfWriters =
                ProcessorHelper2.getNetcdfWriters( projectConfig,
                                                   systemSettings,
                                                   executors.getIoExecutor(),
                                                   outputDirectory );

        // Obtain any formats delivered by out-of-process subscribers.
        Set<Format> externalFormats = ProcessorHelper2.getFormatsDeliveredByExternalSubscribers();
        ...
        try ( SharedWriters sharedWriters = ProcessorHelper2.getSharedWriters( projectConfig,
                                                                               outputDirectory );
                                                                                ...
                                                                                evaluationId ); )
        {
            ...
            Pair<Evaluation, String> evaluationAndProjectHash =
                    ProcessorHelper2.processProjectConfig( evaluationDetails,
                                                           systemSettings,
                                                           databaseServices,
                                                           executors,
                                                           sharedWriters,
            ...
            throws IOException
    {
        ...
        try
        {
            ...
            wres.statistics.generated.Evaluation evaluationDescription =
                    ProcessorHelper2.setAnalyzedUnitsAndVariableNames( evaluationDetails.getEvaluationDescription(),
                                                                       project );
            ...
            for ( MetricsConfig metricsConfig : projectConfig.getMetrics() )
            {
                ...
                int minimumSampleSize = ProcessorHelper2.getMinimumSampleSize( metricsConfig.getMinimumSampleSize() );
            ...
            Set<FeatureGroup> featureGroups = ProcessorHelper2.getFeatureGroups( project,
    ...
    private static wres.statistics.generated.Evaluation getEvaluationDescription( ProjectConfigPlus projectConfigPlus )
    {
        ...
        if ( outputs.hasPng() && outputs.getPng().hasOptions() )
        {
            ...
            template = ProcessorHelper2.getAbsolutePathFromRelativePath( template );
                                           ...
                                           PoolGroupTracker groupPublicationTracker )
    {
        ...
        List<MetricProcessor<Pool<TimeSeries<Pair<Double, Double>>>>> processors =
                ProcessorHelper2.getSingleValuedProcessors( evaluationDetails.getResolvedProject()
                                       ...
                                       PoolGroupTracker groupPublicationTracker )
    {
        ...
        List<MetricProcessor<Pool<TimeSeries<Pair<Double, Ensemble>>>>> processors =
                ProcessorHelper2.getEnsembleProcessors( evaluationDetails.getResolvedProject()
                                                                         .getThresholdsByMetricAndFeature(),
                                                        executors.getThresholdExecutor(),
                                                        executors.getMetricExecutor() );
