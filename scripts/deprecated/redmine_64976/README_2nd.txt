...
By default the data files destination_host is localhost, it can be overrided by -h option.
...
https://{hostname}/nwm/{version}/nwm.yyyymmdd/, you specify more than one data types with '-t' option as:
