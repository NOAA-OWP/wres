 ...
 * into a smaller dataset whose elements all meet the conditions. 
 * 
 * @author james.brown@hydrosolved.com
 */
public class ConditioningConfigurationUnit extends ConfigurationUnit<ConditioningConfigurationUnit> {
