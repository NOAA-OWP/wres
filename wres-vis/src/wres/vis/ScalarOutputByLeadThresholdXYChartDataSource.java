...
public class ScalarOutputByLeadThresholdXYChartDataSource extends DefaultXYChartDataSource
{
    /**
     * The data.
     */
    ...
    {
        final ScalarOutputByLeadThresholdXYChartDataSource copy =
                                                                new ScalarOutputByLeadThresholdXYChartDataSource(getDataSourceOrderIndex(),
                                                                                                                 input);
