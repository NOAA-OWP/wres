...
public class ReliabilityDiagramSampleSizeXYChartDataSource extends DefaultXYChartDataSource
{
    ...
    {
        final ReliabilityDiagramSampleSizeXYChartDataSource copy =
                                                                new ReliabilityDiagramSampleSizeXYChartDataSource(getDataSourceOrderIndex(),
                                                                                                                 input);
    ...
    protected XYDataset buildXYDataset(final DataSourceDrawingParameters parameters) throws XYChartDataSourceException
    {
        ...
        //to make sense here. 
        final ReliabilityDiagramSampleSizeXYDataset dataSet = new ReliabilityDiagramSampleSizeXYDataset(input);
