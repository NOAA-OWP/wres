 ...
 * @author Hank.Herr
 */
public class ReliabilityDiagramSampleSizeXYDataset extends AbstractXYDataset
{
    ...
    {
        return data.get(data.getKey(series)).getData().get(MetricConstants.SAMPLE_SIZE).getDoubles()[item];
    }
