...
ls -d scenario0* scenario1* scenario2* scenario3* scenario4* scenario5* scenario60* scenario7* scenario8* >> $logFileName

echo "System test results for scenarios:" 
ls -d scenario0* scenario1* scenario2* scenario3* scenario4* scenario5* scenario60* scenario7* scenario8*

# Run and time the run.
startsec=$(date +%s)

# The tests to perform are entered manually on this line.
./runtest.sh scenario0* scenario1* scenario2* scenario3* scenario4* scenario5* scenario60* scenario7* scenario8* >> $logFileName
