...
ls -d scenario0* scenario1* scenario2* scenario3* scenario4* scenario5* scenario6* scenario7* scenario8* >> $logFileName

echo "System test results for scenarios:" 
ls -d scenario0* scenario1* scenario2* scenario3* scenario4* scenario5* scenario6* scenario7* scenario8*
