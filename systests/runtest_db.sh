...
then
	egrep -A 5 '(PROCESSING|differ|FAIL|Aborting|Not enough data found for feature)' systests_900screenCatch_"$latest_noZip".txt > systests_900Results_"$latest_noZip".txt
