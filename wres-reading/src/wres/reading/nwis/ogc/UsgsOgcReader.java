...
import wres.reading.nwis.ogc.response.TimeSeriesTuplePlusId;
import wres.statistics.generated.GeometryTuple;
import wres.system.SystemSettings;

import wres.reading.nwis.ogc.response.UsgsOgcResponseReader;
...
public class UsgsOgcReader implements TimeSeriesReader
{
    ...
    {
        LocationMetadata locationMetadata = this.getLocationMetadataFromCacheOrUsgs( featureId, dataSource );
    ...
    /**
     * Attempts to retrieve the location metadata from a local cache, else from USGS.
     *
     * @param featureId the feature
     * @param dataSource the data source
    ...
    private LocationMetadata getLocationMetadataFromCacheOrUsgs( String featureId, DataSource dataSource )
    {
