 ...
 * @since 0.1
 */
class ProbabilityOfDetection extends ContingencyTableScore<DichotomousPairs>
{
    ...
    static class ProbabilityOfDetectionBuilder extends MetricBuilder<DichotomousPairs, ScalarOutput>
    {
