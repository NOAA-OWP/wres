 ...
 * @since 0.1
 */
class ContinuousRankedProbabilitySkillScore extends ContinuousRankedProbabilityScore
{
    ...
    static class CRPSSBuilder extends CRPSBuilder
    {
        @Override
        protected ContinuousRankedProbabilitySkillScore build()
        {
