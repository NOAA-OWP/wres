 ...
 */
abstract class TimeSummaryStatistics extends OrdinaryScore<TimeSeriesOfSingleValuedPairs, DurationScoreOutput>
        implements Collectable<TimeSeriesOfSingleValuedPairs, PairedOutput<Instant, Duration>, DurationScoreOutput>
{
    ...
    final Map<MetricConstants, ToDoubleFunction<VectorOfDoubles>> statistics;
    ...
    public DurationScoreOutput aggregate( PairedOutput<Instant, Duration> output )
    {
        ...
        for ( Entry<MetricConstants, ToDoubleFunction<VectorOfDoubles>> next : statistics.entrySet() )
        {
            ...
            // TODO: consider implementing a summary statistics API for Duration
    ...
    public static abstract class TimeSummaryStatisticsBuilder
            extends OrdinaryScoreBuilder<TimeSeriesOfSingleValuedPairs, DurationScoreOutput>
    {
        ...
        public TimeSummaryStatisticsBuilder setStatistics( Set<MetricConstants> statistics )
        {
    ...
    TimeSummaryStatistics( final TimeSummaryStatisticsBuilder builder ) throws MetricParameterException
    {
        super( builder );
