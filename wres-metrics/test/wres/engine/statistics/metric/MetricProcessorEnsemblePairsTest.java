...
public final class MetricProcessorEnsemblePairsTest
{
    ...
    public void test2ApplyWithValueThresholds()
    {
        ...
        try
        {
            ...
            assertTrue("Expected results differ from actual results for " + MetricConstants.BIAS_FRACTION + " at "
                + bias.getKey(0), bias.getValue(0).getData().equals(0.032093836077598345));
            assertTrue("Expected results differ from actual results for " + MetricConstants.BIAS_FRACTION + " at "
                + bias.getKey(1), bias.getValue(1).getData().equals(0.032093836077598345));
            assertTrue("Expected results differ from actual results for " + MetricConstants.BIAS_FRACTION + " at "
                + bias.getKey(2), bias.getValue(2).getData().equals(0.0365931379807274));
            assertTrue("Expected results differ from actual results for " + MetricConstants.BIAS_FRACTION + " at "
                + bias.getKey(3), bias.getValue(3).getData().equals(0.039706682985140816));
            assertTrue("Expected results differ from actual results for " + MetricConstants.BIAS_FRACTION + " at "
                + bias.getKey(4), bias.getValue(4).getData().equals(0.0505708024162773));
            assertTrue("Expected results differ from actual results for " + MetricConstants.BIAS_FRACTION + " at "
                + bias.getKey(5), bias.getValue(5).getData().equals(0.056658160809530816));
            //Validate CoD
            MetricOutputMapByLeadThreshold<ScalarOutput> cod =
                                                             results.get(MetricConstants.COEFFICIENT_OF_DETERMINATION);
            assertTrue("Expected results differ from actual results for " + MetricConstants.COEFFICIENT_OF_DETERMINATION
                + " at " + cod.getKey(0), cod.getValue(0).getData().equals(0.7873367083297588));
            assertTrue("Expected results differ from actual results for " + MetricConstants.COEFFICIENT_OF_DETERMINATION
                + " at " + cod.getKey(1), cod.getValue(1).getData().equals(0.7873367083297588));
            assertTrue("Expected results differ from actual results for " + MetricConstants.COEFFICIENT_OF_DETERMINATION
                + " at " + cod.getKey(2), cod.getValue(2).getData().equals(0.7653639626077698));
            assertTrue("Expected results differ from actual results for " + MetricConstants.COEFFICIENT_OF_DETERMINATION
                + " at " + cod.getKey(3), cod.getValue(3).getData().equals(0.76063213080129));
            assertTrue("Expected results differ from actual results for " + MetricConstants.COEFFICIENT_OF_DETERMINATION
                + " at " + cod.getKey(4), cod.getValue(4).getData().equals(0.7542039364210298));
            assertTrue("Expected results differ from actual results for " + MetricConstants.COEFFICIENT_OF_DETERMINATION
                + " at " + cod.getKey(5), cod.getValue(5).getData().equals(0.7492338765733539));
            //Validate rho
            ...
            assertTrue("Expected results differ from actual results for " + MetricConstants.CORRELATION_PEARSONS
                + " at " + rho.getKey(0), rho.getValue(0).getData().equals(0.8873199582618204));
            assertTrue("Expected results differ from actual results for " + MetricConstants.CORRELATION_PEARSONS
                + " at " + rho.getKey(1), rho.getValue(1).getData().equals(0.8873199582618204));
            assertTrue("Expected results differ from actual results for " + MetricConstants.CORRELATION_PEARSONS
                + " at " + rho.getKey(2), rho.getValue(2).getData().equals(0.8748508230594344));
            assertTrue("Expected results differ from actual results for " + MetricConstants.CORRELATION_PEARSONS
                + " at " + rho.getKey(3), rho.getValue(3).getData().equals(0.8721422652304439));
            assertTrue("Expected results differ from actual results for " + MetricConstants.CORRELATION_PEARSONS
                + " at " + rho.getKey(4), rho.getValue(4).getData().equals(0.868449155921652));
            assertTrue("Expected results differ from actual results for " + MetricConstants.CORRELATION_PEARSONS
                + " at " + rho.getKey(5), rho.getValue(5).getData().equals(0.8655829692024641));
            //Validate mae
            MetricOutputMapByLeadThreshold<ScalarOutput> mae = results.get(MetricConstants.MEAN_ABSOLUTE_ERROR);
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ABSOLUTE_ERROR + " at "
                + mae.getKey(0), mae.getValue(0).getData().equals(11.009512537315405));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ABSOLUTE_ERROR + " at "
                + mae.getKey(1), mae.getValue(1).getData().equals(11.009512537315405));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ABSOLUTE_ERROR + " at "
                + mae.getKey(2), mae.getValue(2).getData().equals(17.675554578575642));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ABSOLUTE_ERROR + " at "
                + mae.getKey(3), mae.getValue(3).getData().equals(18.997815872635968));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ABSOLUTE_ERROR + " at "
                + mae.getKey(4), mae.getValue(4).getData().equals(20.625668563442147));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ABSOLUTE_ERROR + " at "
                + mae.getKey(5), mae.getValue(5).getData().equals(22.094227646773568));
            //Validate me
            MetricOutputMapByLeadThreshold<ScalarOutput> me = results.get(MetricConstants.MEAN_ERROR);
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ERROR + " at "
                + me.getKey(0), me.getValue(0).getData().equals(1.157869354367079));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ERROR + " at "
                + me.getKey(1), me.getValue(1).getData().equals(1.157869354367079));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ERROR + " at "
                + me.getKey(2), me.getValue(2).getData().equals(2.1250409720950105));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ERROR + " at "
                + me.getKey(3), me.getValue(3).getData().equals(2.4855770739425846));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ERROR + " at "
                + me.getKey(4), me.getValue(4).getData().equals(3.4840043925326936));
            assertTrue("Expected results differ from actual results for " + MetricConstants.MEAN_ERROR + " at "
