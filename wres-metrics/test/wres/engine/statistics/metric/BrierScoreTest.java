...
public final class BrierScoreTest
{
    ...
    public void test1BrierScore()
    {
        ...
        final VectorOutput expected = MetricOutputFactory.ofVectorOutput(new double[]{0.26}, 6, null);
        assertTrue("Actual: " + actual.getData().getDoubles()[0] + ". Expected: " + expected.getData().getDoubles()[0]
            + ".", actual.equals(expected));
        //Check the parameters
        assertTrue("Unexpected name for the Brier Score.", bs.getName().equals("Brier Score"));
