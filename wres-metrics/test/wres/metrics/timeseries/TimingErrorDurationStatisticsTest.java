...
public final class TimingErrorDurationStatisticsTest
{
    ...
    public void testApplyOneStatisticPerInstance() throws MetricParameterException
    {
        ...
        com.google.protobuf.Duration expectedSource = MessageUtilities.getDuration( Duration.ofHours( 3 ) );
        ...
        assertEquals( MessageUtilities.getDuration( Duration.ofHours( 12 ) ),
        ...
        assertEquals( MessageUtilities.getDuration( Duration.ofHours( -6 ) ),
        ...
        assertEquals( MessageUtilities.getDuration( Duration.ofHours( 9 ) ),
    ...
    public void testApplyMultipleStatisticInOneInstance() throws MetricParameterException
    {
        ...
        com.google.protobuf.Duration expectedMeanAbs = MessageUtilities.getDuration( Duration.ofHours( 9 ) );
