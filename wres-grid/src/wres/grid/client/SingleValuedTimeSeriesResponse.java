...
public class SingleValuedTimeSeriesResponse implements Response<Double>
{
    ...
    private final Map<Feature, Stream<TimeSeries<Double>>> timeSeriesPerFeature;
    ...
    @Override
    public Map<Feature, Stream<TimeSeries<Double>>> getTimeSeries()
    {
    ...
    public static SingleValuedTimeSeriesResponse of( Map<Feature, Stream<TimeSeries<Double>>> timeSeriesPerFeature,
                                                     String variableName,
    ...
    private SingleValuedTimeSeriesResponse( Map<Feature, Stream<TimeSeries<Double>>> timeSeriesPerFeature,
                                            String variableName,
                                            String measurementUnits )
    {
