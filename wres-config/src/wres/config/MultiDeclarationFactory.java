...
public class MultiDeclarationFactory
{
                                              ...
                                              boolean validate ) throws IOException
    {
        ...
        MediaType detectedMediaType = DeclarationUtilities.getMediaType( declarationString );

        if ( DeclarationUtilities.isOldDeclarationString( detectedMediaType, declarationString ) )
        {
            ...
            throws IOException
    {
        ...
        if ( validate )
        {
            DeclarationValidator.validate( migrated, false, true );
        }
